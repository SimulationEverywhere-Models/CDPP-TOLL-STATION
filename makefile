...
EXAMPLESOBJS=queue.o main.o generat.o cpu.o transduc.o trafico.o distri.o com.o linpack.o debug.o timer.o barrera.o lector.o sensor.o cola.o control.o cajero.o genpago.o genautos.o register.o
LIBNAME=simu
LIBS=-lsimu
...
genpago.o: genpago.cpp
	${CPP} -c ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $<

genautos.o: genautos.cpp
	${CPP} -c ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $<
